...
export default class App extends React.Component {
  ...
  toggleCompleted(todoId) {
    ...
    const todos = this.state.todos;
    const todosCopy = [...todos];
    const index = todosCopy.map(obj => obj.todoId).indexOf(todoId);
    const status = !todosCopy[index].isCompleted;
    const opposite = {
      isCompleted: status
    };

    todosCopy[index].isCompleted = status;
    // const todoEdited = todosCopy[index];
    // console.log('ok final', todoEdited);
